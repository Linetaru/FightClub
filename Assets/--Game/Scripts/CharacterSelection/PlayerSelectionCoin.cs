...
public class PlayerSelectionCoin : MonoBehaviour
{
    ...
    //[SerializeField]
    //CharacterSelectionCell[] characterCells = new CharacterSelectionCell[5];
    ...
    //{
    //    actualPosition = 2;
    //    transform.position = characterCells[2].transform.position;
    //    transform.rotation = characterCells[2].transform.rotation;
    //}
